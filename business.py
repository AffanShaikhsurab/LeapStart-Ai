...
# You will need to create a 'templates' directory and place a 'report_template.html' file inside it.
# The HTML template can use Jinja2 syntax to display the report data.
